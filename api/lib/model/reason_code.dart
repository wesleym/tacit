...
class ReasonCode {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ReasonCode;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ReasonCode[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ReasonCode[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ReasonCode> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ReasonCode>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ReasonCode>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ReasonCode.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
